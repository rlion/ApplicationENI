...
CREATE TABLE [dbo].[FORMATIONSECF](
	[idECF] [char](8) NOT NULL,
	[idFormation] [char](8) NOT NULL,
 CONSTRAINT [PK_FORMATIONSECF] PRIMARY KEY CLUSTERED 
(
	[idECF] ASC,
	[idFormation] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[FORMATIONSECF]  WITH CHECK ADD  CONSTRAINT [FK_ECFFormations_ECFS] FOREIGN KEY([idECF])
REFERENCES [dbo].[ECF] ([idECF])
GO

ALTER TABLE [dbo].[FORMATIONSECF] CHECK CONSTRAINT [FK_ECFFormations_ECFS]
GO

ALTER TABLE [dbo].[FORMATIONSECF]  WITH CHECK ADD  CONSTRAINT [FK_ECFFormations_Formation] FOREIGN KEY([idFormation])
REFERENCES [dbo].[Formation] ([CodeFormation])
GO

ALTER TABLE [dbo].[FORMATIONSECF] CHECK CONSTRAINT [FK_ECFFormations_Formation]
GO
