...
namespace ApplicationENI.DAL
{
    static class JeuDonnees
    {
        ...
        public static List<Stagiaire> GetListeStagiaire() {
            Entreprise testE = new Entreprise();
            Contact tuteur = new Contact(1, "Jones", "Indiana", "0202020202", "0602020202", "0202020202", "indianajones@gmail.com", "il est sympa", "", "Melle", testE, "");
        ...
        public static Contact GetContact() {
            Entreprise testE = new Entreprise();
            Contact c = new Contact(1, "contact", "Jean", "0202020202", "0602020202", "0202020202", "jean@jean.fr", "semble correct", "", "M.", testE, "");
            return c;
        }
