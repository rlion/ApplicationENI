...
namespace ApplicationENI.DAL
{
    ...
    {
        //TODO Mat
        static String SELECT_EVALUATIONS = "SELECT * FROM  WHERE ";
        static String INSERT_EVALUATION = "INSERT INTO  VALUES (@id, @date, @nom_auteur, @type, @titre, @texte, @num_stagiaire)";
        static String DELETE_EVALUATION = "DELETE FROM WHERE ";
        static String UPDATE_EVALUATION = "UPDATE  SET WHERE ";
